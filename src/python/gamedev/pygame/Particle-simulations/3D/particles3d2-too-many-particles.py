...
while len(colors) < NUMBER_OF_COLORS:
	...
	if not new_color in colors and not (new_color[0] == new_color[1] == new_color[2]):
...
for i in range(NUMBER_OF_PARTICLES):
	rand_pos = Vector(randint(15, WIDTH - 15), randint(15, LENGTH - 15), randint(15, HEIGHT - 15))
	par = Particle(rand_pos, colors[randint(0, NUMBER_OF_COLORS - 1)])
