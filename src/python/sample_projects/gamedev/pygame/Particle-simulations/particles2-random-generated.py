...
class Particle():
	...
	def __repr__(self):
		# return Particle.colors[self.color]
		return str(self.net_force)
...
while run:
	...
	if time_step % 100 == 0:
		...
		rand_x = randint(10 + Particle.RADIUS, WIDTH - 10 - Particle.RADIUS)
		rand_y = randint(10 + Particle.RADIUS, HEIGHT - 10 - Particle.RADIUS)
		pa = Particle(rand_x, rand_y, rand_color)
		pa.velocity = (0.01 * Vector(randint(0, 10), randint(0, 10)))
		space.particles.append(pa)
	time_step += 1
