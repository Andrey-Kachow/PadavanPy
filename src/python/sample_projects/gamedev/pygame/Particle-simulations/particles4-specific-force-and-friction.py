...
g = Particle(550, 150, red)
h = Particle(650, 250, green)
i = Particle(750, 350, blue)
j = Particle(850, 150, red)
k = Particle(950, 250, green)
l = Particle(50, 350, blue)


space = Space([a, b, c, d, e, f, g, h, i, j, k, l])
# space = Space([])
