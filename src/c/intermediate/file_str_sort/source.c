...
/*
  Статический масив безусловный буфер хранения
*/
...
/*
  Статический масив указателей на остатки строк в инамической памяти.

  Оторванные концы строк будут храниться с дополнительным
  нулевым байтом-терминатором строки
*/
char *extra_space[STRINGS_COUNT];

/*
  Пример: Строки "Привет" "Как" "Делишки" с STRINGS_COUNT 3 и MAX_STRING_SIZE 3
...
// static void test_mock_file_io(void);
...
/*
  Замена символа новой строки на нулевой символ.
  Нужен для того, чтобы результат функции getline не имел символа
  конца строки, и в файле назначения для записи сортированного списка слов
  не было новой строки
*/
...
/*
  Замена соответствующих элементов в статическом массиве символов
  И Замена указателей в массиве указателей на концы строк в динамической памяти
*/
...
/*
  Сравнение строк, частично хранящихся в динамическом, частично в статическом массиве.
  Динамические массивы сравниваются, только если содержимое в статическом масиве совпадает
*/
...
/*
  Распределение несортированного подмассива на две группы
  "Больше" и "Меньше" образца, с ыпомощью перемены значенийй местами
*/
...
/*
  Реализация быстрой сортировки части массива без выделения новой памяти
*/
...
/*
  Реализация быстрой сортировки полного массива без выделения новой памяти.
  Весь массив рассматривается как свой собственный подмассив
*/
...
/*
  Вывод строки из массивов. Второй аргумент решает,
  выводить в стандартный вывод (консоль) или в файл.
  Третий аргумент определяет, будут ли выводиться кавычки
*/
...
/*
  Отладочный вывод всех строк в кавычках в консоль стандартного вывода.
*/
...
/*
  Чтения строки и сохраения ее первых MAX_STRING_SIZE символов в статический массив
  и ее отстатки в динамический массив, не забывая поставить нулевой байт в конце
*/
...
/*
  Очищение всех динамических массивов
*/
void clean_up(void) {
  for (int i = 0; i < actual_string_count; i++) {
    free(extra_space[i]);
...
/* Эта функция должна, по идее работать на винде. Попробуй обе!
   Чтение строк из файла и запись в массивы */
...
/* Запись строк из массива в файл */
...
/*
  Тест функция для демонстрации сортировки без чтения из файла
*/
